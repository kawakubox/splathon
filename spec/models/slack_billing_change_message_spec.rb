...
RSpec.describe SlackBillingChangeMessage do
  describe ".parse" do
    ...
    context 'when deactivate' do
      ...
      its(:account_name) { is_expected.to eq 'Oda .Cupsule.LLC' }
    ...
    context 'when became xxx' do
      ...
      its(:account_name) { 'ろーる at BizReach' }
    ...
    context 'when is no longer xxx' do
      ...
      its(:account_name) { is_expected.to eq 'まけトピア (東京大学 / ex-dwango)' }
